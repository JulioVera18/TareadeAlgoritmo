																								...
																								Sino 
																									...
																									Sino 
																										Si opc="25"Entonces
																											...
																											Ejercicio25
																										SiNo
																											Escribir "Error su opcion no esta en el menu"
																										FinSi
																									FinSi
																								FinSi
																							FinSi
...
Funcion Ejercicio2 
	...
	leer edad_usuario
	si edad<=18 Entonces
		Escribir edad_usuario "si puede votar"
	SiNo
		Escribir edad_usuario "no puede votar"
	FinSi
FinFuncion
...
Funcion Ejercicio7
	...
	Si dia >= 1 y dia <= 31 Entonces
		Si dia >= 1 y dia <= 15 Entonces
			Escribir "Es la primera parte de la quincena"
		SiNo
			Escribir "Es la segunda parte de la quincena"
		FinSi
	SiNo
		Escribir "Error a sobrepasado el dia limiete de un mes"
	FinSi
FinFuncion
...
//               tasaImpuesto <- 0.05
//            Sino salarioAnual <= 20000 Entonces
//                 tasaImpuesto <- 0.1
//Salida: Impuesto 
Funcion Ejercicio12
    ...
    SiNo
        ...
        FinSi
    FinSi
    impuesto <- salarioAnual * tasaImpuesto
...
Funcion Ejercicio15 
	...
	Si totalcompras>500 Entonces 
		...
		totaldescuento= totalcompras-descuento
	Sino 
		totaldescuento=totalcompras
	FinSi
	//Iva
	iva = totaldescuento*0.15
	totalfinal= totaldescuento+iva
	//Calculo 
	Escribir "Total de compras mensuales es: ", totalcompras
	Escribir "Total de descuento: ", totaldescuento
...
Funcion Ejercicio16
	...
	impuesto=0
	total=0
	Escribir "Ingrese la cantidad de unidades opor producto: "
	Leer cantidadunidades
	Escribir "Ingrese el precio unitario del producto: "
	Leer preciounitario
	precio = cantidadunidades*preciounitario
	//DESCUENTOS 
	Si cantidadunidades >= 20 y cantidadunidades<= 40  Entonces
		descuento= precio *0.15
		totaldescuento= precio-descuento
		Escribir "El total a pagar es: ", totaldescuento
	Sino 
		Si cantidadunidades >= 41  y cantidadunidades <= 90 Entonces
	...
	// Calculo 
	//Al costo total debe aplicar el 15% de impuestos
	impuesto= totaldescuento *0.15
	total= totaldescuento-impuesto
...
Funcion Ejercicio17
	...
	Leer costohora
	//Calculo
	costototal= horasservi* costohora
	
	Si horasservi >10 Entonces
		desc= costototal*0.20
...
//				SiNo
//					platillo = 75
//			platillo = personas * platillo
//			descuento = platillo - (platillo * 0.25)
//			total = desceunto + (descuento * 0.15)
//Salida:	total
Funcion Ejercicio18
	Definir personas, costopersona, totalsindesc, decuento,iva, totalfinal, totaldescuento como Real 
	personas= 0
	totalsindesc=0
	descuento=0
	iva=0
	...
	FinSi
	//Calculo
	totalsindesc= personas*costopersona
	descuento= totalsindesc*0.20
	totaldescuento = totalsindesc-descuento
	iva=totaldescuento *0.15
	totalfinal= totaldescuento+iva
	Escribir "El total sin descuento es igual a:  ", totalsindesc
	Escribir "El descuento es de: ", descuento
	Escribir "El total con descuento es:  ", totaldescuento
...
//				pasaje = 20
//			SiNo
//				si alumno >100 y alumno < 199
//					pasaje = 30
//				SiNo
//					si alumno > 50 y alumno < 99
//						pasaje = 40
//					SiNo
//						si alumno < 50
//							pasaje = 50
...
//Salida.	total
Funcion Ejercicio20
	Definir alumnos, costo, total Como Real
	alumnos = 0; costo = 0; total = 0
...
//						csoto = 3
//			si personas >= 20
//				costot = personas * kilometro * costo
//				total = costot + (costot * 0.15)
//Salida:	total
Funcion Ejercicio21
	Definir tbus Como Caracter
	Definir npersonas, costot, kilometro Como Real
	tbus = ""
	npersonas = 0
	costot = 0
	Escribir "Que tipo de bus es (A, B, C)"; Leer tbus
	tbus = Mayusculas(tbus)
	Si tbus = "A" Entonces
		costo = 2
		Escribir "Costo del Bus: 2"
	SiNo
		Si tbus = "B" Entonces
			costo = 2.5
			Escribir "Costo del Bus: 2.5"
		SiNo
			Si tbus = "C" Entonces
				costo = 3
				Escribir "Costo del Bus: 3"
			SiNo
				Escribir "Error tipo no valido"
			FinSi
		FinSi
	FinSi
	Escribir "Cuantas perosonas son: "; Leer npersonas
	Escribir "Distancia en kilometro recorrido: "; Leer kilometro
	Si npersonas >= 20 Entonces
		costot = npersonas * costo * kilometro
		total = costot + (costot * 0.15)
		Escribir "Distancia: ",kilometro," Km"
		Escribir "Iva: 15%"
		Escribir "Total a pagar: $", total
	SiNo
		Escribir "Error numero de personas insuficientes"
	FinSi
FinFuncion
...
//			SiNo
//				La letra ingresado NO es una letra del alfabeto
//Salida.	letra
Funcion Ejercicio22
	Definir letra Como Caracter
	letra = ""
	Escribir "Ingrese un letra:"; Leer letra
	letra = Mayusculas(letra)
	Si letra >= "A" y letra <= "Z" Entonces
		Escribir "La letra ",letra," ingresado es una letra del alfabeto."
	SiNo
		Escribir "La letra ",letra," ingresado NO es una letra del alfabeto."
	FinSi
FinFuncion
...
Funcion Ejercicio23
	...
	car = ""
	Escribir "Ingrese un cualquier cosa:"; Leer car
	car = Mayusculas(car)
...
//				SiNo
//					El segundo valor es mayor al primero
//Salida:	caracter1 caracter2
Funcion Ejercicio24
	Definir a, b Como Caracter
	a = ""; b = ""
	Escribir "Ingresa una letra: "; Leer a
	Escribir "Ingresa una letra: "; Leer b
	Si a = b Entonces
...
//			SiNo
//				Si frase1 > frase2 
//					La primera frase es mayor a la segunda
//				SiNo
//					La segunda frase es mayor a la primera
//Salida:	frase1 frase2
Funcion Ejercicio25
	...
	SiNo
		Si frase1 > frase2 Entonces
			Escribir "La primera frase es mayor a la segunda"
		SiNo
			Escribir "La segunda frase es mayor a la primera"
		FinSi
	FinSi
FinFuncion
